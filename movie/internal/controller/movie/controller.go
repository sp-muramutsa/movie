...
type ratingGateway interface {
	...
	PutAggregatedRating(ctx context.Context, recordId ratingmodel.RecordID, recordType ratingmodel.RecordType, rating *ratingmodel.Rating) error
}
...
func (c *Controller) Get(ctx context.Context, id string) (*model.MovieDetails, error) {
	...
	if err != nil && !errors.Is(err, gateway.ErrNotFound) {
		// Proceed. It's okay not to have ratings yet.
	} else if err != nil {
		return nil, err
	} else {
