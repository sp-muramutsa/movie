...
// Ingest starts ingestion from Kafka and returns a chanel containing rating events representing the data consumed from the topic
func (i *Ingester) Ingest(ctx context.Context) (chan model.RatingEvent, error) {
	fmt.Println("Starting a Kafka ingester")
